...
import ModalEditarPerfilAdmi from "../modalestuto/ModalEditarPerfilAdmi"
...
export default function Rightbar({ profile }) {
  ...
  getUser()
    ...
    return (
      <>
        <h4 className="rightbarTitle">Información de Usuario <EditAdmin /><ModalEditarPerfilAdmi/></h4>
